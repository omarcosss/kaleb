...
{{--        <img src="{{ asset('assets/images/chaoconvite.png') }}" alt="chão" class="chaoconvite">--}}
{{--        <img src="{{ asset('assets/images/arvores.png') }}" alt="árvores" class="arvores">--}}
        <div class="rainbow-container">
            <img src="{{ asset('assets/images/rainbow.png') }}" alt="arco-íris laranja" class="rainbow">
    ...
    <section id="ver-mais">
        ...
        @endif
        teste
        <buttun id="open-modal-rsvp">rsvp</buttun>
    </section>
